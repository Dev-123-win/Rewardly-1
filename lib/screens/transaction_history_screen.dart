...
class _TransactionHistoryScreenState extends State<TransactionHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> transactions = [
      {'type': 'earning', 'subType': 'daily_reward', 'amount': 10, 'timestamp': '2025-01-15'},
      {'type': 'earning', 'subType': 'ad', 'amount': 4, 'timestamp': '2025-01-15'},
      {'type': 'withdrawal', 'subType': 'upi', 'amount': -100, 'timestamp': '2025-01-14'},
    ];

    final filteredTransactions = _selectedFilter == 'All'
        ? transactions
        : transactions.where((t) => t['type'] == _selectedFilter.toLowerCase()).toList();
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            title: Text(transaction['subType'].replaceAll('_', ' ').toUpperCase()),
